...
<div class="min-h-screen flex flex-col lg:flex-row bg-slate-50">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
        <div class="w-full max-w-md">
            ...
            <div class="mb-10">
                <h2 class="text-3xl font-bold text-slate-900 mb-2">Bienvenue parmi nous !</h2>
                <p class="text-slate-500">Veuillez entrer vos informations pour créer votre compte.</p>
            </div>
