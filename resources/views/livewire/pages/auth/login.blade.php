...
<div class="min-h-screen flex items-center justify-center bg-[#F5F6FA] py-12 px-4 sm:px-6 lg:px-8 font-['DM_Sans',sans-serif]">
    <div class="max-w-md w-full bg-white rounded-sm shadow-sm border border-[#E8EAF0] p-8">
        ...
        <div class="flex flex-col items-center justify-center text-center mb-8">
            ...
            <h2 class="text-2xl font-bold font-['Syne',sans-serif] text-gray-900">Bon retour parmi nous !</h2>
            <p class="mt-2 text-sm text-gray-500">Veuillez entrer vos identifiants pour accéder au tableau de bord.</p>
        </div>

        <form wire:submit="login" class="space-y-5">
            <div>
                <label class="block text-[10px] font-bold font-['Syne',sans-serif] tracking-wider uppercase text-gray-500 mb-1.5">Adresse Email</label>
                <div class="relative group">
                    ...
                    <input wire:model="form.email" type="email" required autofocus class="w-full pl-10 pr-4 py-2.5 bg-[#F5F6FA] border border-[#E8EAF0] rounded-sm font-['DM_Sans',sans-serif] text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all" placeholder="nom@entreprise.cm">
                </div>
            ...
            <div x-data="{ show: false }">
                <div class="flex justify-between items-end mb-1.5">
                    <label class="block text-[10px] font-bold font-['Syne',sans-serif] tracking-wider uppercase text-gray-500">Mot de passe</label>
                    <a href="{{ route('password.request') }}" class="text-[10px] font-bold font-['Syne',sans-serif] text-orange-500 hover:text-orange-600 transition-colors uppercase tracking-wider">Oublié ?</a>
                </div>
                <div class="relative group">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 group-focus-within:text-orange-500 transition-colors">
            ...
            <div class="flex items-center mt-4">
                <input id="remember" type="checkbox" class="w-4 h-4 text-orange-500 border-[#E8EAF0] bg-[#F5F6FA] rounded-sm focus:ring-orange-500 focus:ring-offset-0">
                <label for="remember" class="ml-2 text-xs text-gray-500">Rester connecté</label>
            </div>
        ...
        <p class="mt-8 text-center text-xs text-gray-500">
            Pas encore de compte ? <a href="{{ route('register') }}" class="text-orange-500 font-bold hover:text-[#EA580C] transition-colors">Créer un compte</a>
        </p>
    </div>
</div>
