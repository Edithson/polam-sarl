        ...
        <div class="container mx-auto px-6 max-w-7xl">
            <div id="hero-content" class="max-w-2xl transition-all duration-500 transform translate-y-0 opacity-100">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#contact" class="group relative flex items-center justify-center bg-[var(--orange)] text-[#000] px-8 py-4 font-heading font-bold text-sm uppercase tracking-widest hover:bg-[var(--orange-glow)] transition-all duration-300" style="clip-path: polygon(10px 0%, 100% 0%, calc(100% - 10px) 100%, 0% 100%);">
                        Démarrer un projet
                    ...
                    <a href="#services" class="btn-ghost" style="padding: 1rem 2rem;">
                        Nos expertises
                    </a>
                </div>
