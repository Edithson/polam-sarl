    ...
    <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#services" class="text-gray-400 hover:text-green-400 transition">Archivage Manuel</a></li>
                    <li><a href="#services" class="text-gray-400 hover:text-green-400 transition">Archivage Électronique</a></li>
                    <li><a href="#services" class="text-gray-400 hover:text-green-400 transition">Solutions GEIDE</a></li>
                    <li><a href="#services" class="text-gray-400 hover:text-green-400 transition">Dématérialisation</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <a href="#" class="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-600 transition">
        ...
        <div class="border-t border-gray-800 pt-8 text-center">
            <p class="text-gray-400">&copy; 2025 CINV-CORSA. Tous droits réservés. | Développé pour l'excellence documentaire</p>
        </div>
    </div>
</footer>
